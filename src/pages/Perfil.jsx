    ...
    <div className="container py-4">
      ...
      {perfil ? (
        <div style={{ background: "#161616", border: "1px solid #2A2A2A", borderRadius: "16px", padding: "24px", marginBottom: "24px" }}>
          <p style={{ color: "#777", fontSize: "0.8rem", marginBottom: "4px" }}>NOMBRE</p>
          <p style={{ fontWeight: 600, marginBottom: "16px" }}>{perfil.nombres} {perfil.apellidos}</p>
          <p style={{ color: "#777", fontSize: "0.8rem", marginBottom: "4px" }}>EMAIL</p>
          <p style={{ fontWeight: 600, marginBottom: "16px" }}>{perfil.email}</p>
          <p style={{ color: "#777", fontSize: "0.8rem", marginBottom: "4px" }}>TELÉFONO</p>
          <p style={{ fontWeight: 600 }}>{perfil.telefono || "—"}</p>
        </div>
      ) : (
        !error && <p style={{ color: "#777" }}>Cargando...</p>
      )}
        ...
        <>
          ...
          {direcciones.map((d, i) => (
            <div key={i} style={{ background: "#161616", border: "1px solid #2A2A2A", borderRadius: "12px", padding: "16px", marginBottom: "12px" }}>
              <p style={{ fontWeight: 600, marginBottom: "4px" }}>{d.direccion_detallada}</p>
              <p style={{ color: "#777", fontSize: "0.85rem" }}>{d.distrito}, {d.provincia}, {d.departamento}</p>
